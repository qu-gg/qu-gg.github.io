---
title: Items of the Junkers and Tinkerers (Gear)
date: 2026-04-05
time: 07:45
tags: BREAK!! Homebrew
---

My group's been on a bit of a hot streak with BREAK!! item creation lately. Along with this post, I've added 2 more items - Feather Stones and the Feather-Touched Pouch - to the [Druid/Fey Items](https://its.quagg.studio/blog/posts-html/2026-03-21-items-of-the-druids-and-faeries-gear.html) post. Been working on prep for running the Cog-based adventure within my [Helical Expeditions](https://its.quagg.studio/break.html#helical-expeditions) book, and wanted to build out potential tinkerer-esque items found across Stahlfeld. Here are my attempts. Enjoy!
...
name: A Coat of Arms
type: Backpack
desc: After hearing the 100th Junker complain 'if only they had a third arm', \none pragmatic Junker finally took the problem into their own hands.
effect:
...
![Coat of Arms Inspiration](https://cdna.artstation.com/p/assets/images/images/020/170/282/large/wouter-gort-zera-colour-2-small.jpg?1566673892 "Art by: [Wouter Gort](https://wokkie.artstation.com/projects/VdQqDX)"){: width="27%"}
...
type: Techno-Relic
desc: Any Oldtech Junker worth their scrap on Stahlfeld has managed, one way or another, \nto secure this life-saving relic for diving into the junkyards.
effect:
...
:::item
name: Gobbie Scrap Bracer
type: Weapon
desc: What just looks like a weird wrought-iron bracer turns out to actually be one nasty weapon in disguise. \nA sharp rotation of the wrist activates this bracer, exposing a set of three hooked blades. 
effect: 
...
:::item
name: Junk Trophy System
type: Gadget
desc: This bandolier made of a weird leather hoists a cumbersome shoulder-mounted, pressurized scrap cannon. \nJunkyard goblins have found a means of recreation with these gadgets in a game they call "Rocket Jump".
effect: 
...
name: Flash Pop
type: Combustible
desc: A common, if vague, piece of advice from older Junkers is to always wear your Blackout Goggles, even while sleeping. Anyone hit with the classic "Flash, Pop, and Run!" scrapyard prank can tell you exactly where that advice comes from.
effect: 
