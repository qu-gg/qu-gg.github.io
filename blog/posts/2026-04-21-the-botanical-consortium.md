---
title: The Botanical Consortium (Adventure Site)
date: 2026-04-23
time:  12:20
tags: BREAK!! Homebrew
---

Here is my attempt/write-up for an Adventure Site I recently ran as part of my ongoing BREAK!! campaign. Given this is more a "throwaway" site of my campaign than a presentable module or anything, it is fairly rough around the edges without full completeness. It was quite inspired by the [Magitech Facility](https://breakrpg.blogspot.com/2017/06/magitech-facility-demo-adventure-site.html) BREAK!! demo adventure site - credit where it is due. Other credits include Elsewhere inspiration from the [Gardens of Ynn](https://soulmuppetpublishing.itch.io/the-gardens-of-ynn) and map usage from [DysonLogos](https://dysonlogos.blog/2023/05/16/bore-facility-p44/).

I hope you find some use of it!

**Site's History:** What started in the early 3rd Aeon as a well-intentioned joint venture in botany between the budding empires of Gley and Calian quickly devolved into their usual hijinks of manipulating the laws of the world around them. Their founding mantra was "to understand the life around us is to understand ourselves". While some might argue they kept to that mantra, the meaning of it changed drastically when they found the means of opening a portal to an Elsewhere of twisted gardens called [Ynn](https://soulmuppetpublishing.itch.io/the-gardens-of-ynn). It was discovered by the Head Calian Researcher Norin Rex that root snippings from the plants of this Elsewhere could alter the flesh of mortal creatures; creatures which would survive the transformation. Thus, the seeds of Fleshwarping were sown and experiments were attempted in secret behind Gley's oversight. It is claimed by some that the eventual fall and abandonment of this Facility came as the result of the secret literally bursting forth...in the form of a Grimwing breaching containment and razing the place to the ground.
...
An uneasy blanket of Dark (or Flesh)-based Mana permeates the area as you close in on it and one with astute hearing could swear they hear the ambient sounds of a soft [garden waltz](https://www.youtube.com/watch?v=qUMcdDOAMu4) filtering through the ground. Multiple large pipes jut out of the cliffside's base where an obvious sludgey pour of waste spews forth into the rivers cutting through the Site.
...
![The Botanical Consortium Adventure Slice](../images/BotanicalConsortiumAdventureSlice.png "Vertical slice of The Botanical Consortium. Map by [DysonLogos](https://dysonlogos.blog/2023/05/16/bore-facility-p44/0) [Modified]"){: width="65%"}

### Site Keys

![The Botanical Consortium Adventure Map](../images/BotanicalConsortiumMap.png "Map of The Botanical Consortium. Map by [DysonLogos](https://dysonlogos.blog/2023/05/16/bore-facility-p44/)."){: width="65%"}
...
**2. Crumbled Wall [Access Point]:** Along the rusting Gleysian Alloy security wall lies faded iconography of the empires. Down the stretch, two obvious sections of the wall are breached and crumbled, large enough for all to fit through. A gang of 6 Wood Lalkas sit atop the walls, eagerly waiting to push debris on the heads of those walking in (Falling Debris [CLICK!! Trap](https://its.quagg.studio/the-helical-expeditions/reference-pages.html)).
...
**5. Entrance Hall [Trap]:** A plain, functional entrance hallway. Across the staircase has some simple shelves (Insight Check to notice it hiding **Room 7**'s door) while the corner has a cracked, though functional, Gleysian terminal in an outcrop and the closed door to **Room 6**. The Gleysian Terminal requires a Tier 1 Keycard but is vulnerable to hacking. One failed attempt is safe, further failed attempts invokes a Dark Apparition [CLICK!! Trap](https://its.quagg.studio/the-helical-expeditions/reference-pages.html) by means of an angry semi-sentient AI trapped in the Terminal.

Without proper authentication, a Poison [CLICK!! Trap](https://its.quagg.studio/the-helical-expeditions/reference-pages.html) is present halfway down the stretch - activating it releases noxious spores to flood the entire hallway. Proper protection bypasses the Check.
...
:::item
name: Half-Mask of Tangibility
type: Wearable Accessories
desc: A beautifully angular half-mask made of porcelain, it wears a drastic weeping expression and obfuscates the wearer's \neye entirely. Gleysian records confirm that the other half was made, though its location has been lost to time.
effect:
